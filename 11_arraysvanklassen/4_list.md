...
De klasse `List<>` is een zogenaamde generieke klasse \([zien we later]()\). Tussen de `< >`tekens plaatsen we het type dat de lijst zal moeten gaan bevatten. Bijvoorbeeld:
