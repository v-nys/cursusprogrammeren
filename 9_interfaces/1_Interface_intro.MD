...
In het hoofdstuk Polymorfisme bespraken we een voorbeeld van een klasse ``President`` die enkele ``Advisor``-klassen gebruikt om hem te helpen ([lees hier na](../11_polymorfisme/11_polymo_intro.md#polymorfisme-in-de-praktijk-presidenten)).
