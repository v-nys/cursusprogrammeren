...
- Constructor is een method om een nieuwe instantie (=object) van een class aan te maken
...
**Ideaal om bepaalde class-members op begin waarde te initialiseren**
...
- Ieder object maakt zijn eigen Ranodm aan.
- Elke random generator genereren dezelfde random getallen als die vlak na mekaar in tijd zijn aangemaakt
