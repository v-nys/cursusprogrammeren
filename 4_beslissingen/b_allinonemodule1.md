...
* **Menuitem 2 - Pasword tester:** Vraag aan de gebruiker z'n paswoord. Indien dit gelijk is aan "TrumpSux" zal er een groene tekst "Toegelaten" verschijnen. Zoniet een rode "Verboden" tekst.
...
* **Menuitem 4  - Computersolver :** Implementeer volgende flowchart ![](/assets/2_beslissingen/simpleflow.jpg). Een ruit geeft aan dat je een ja/nee vraag aan de gebruiker stelt (gebruik de tekst dus in de ruit). Een rechthoek (ook die met ronde hoeken) is tekst die je aan de gebruiker toont.