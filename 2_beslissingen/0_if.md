...
Met de [relationele operators](2_beslissingen/1_logic_and_relationsoperator.md) (++, !=, <, >, <= en >=) kunnen we expressie schrijven die als uitkomst waar (true) of niet waar (false) geven.
...
if(c < 0) Console.WriteLine("c is negative"); 
```
We kunnen ook meerdere expressie combineren zodat we complexere uitdrukkingen kunnen maken. Hierbij kan je gebruik maken van de [logische operators](2_beslissingen/1_logic_and_relationsoperator.md) *AND (&&)** en **OR (||)** operators. .
